...
import com.fudan.tick.util.CountDownTimer;
import com.fudan.tick.database.TickDBAdapter;
import com.fudan.tick.util.CountDownTimer;
import com.fudan.tick.util.Sound;
import com.fudan.tick.util.TimeFormatUtil;
import com.fudan.tick.util.WakeLockHelper;
...
public class TickService extends Service implements CountDownTimer.OnCountDownTickListener {
    ...
    private static final String CHANNEL_ID_FOREGROUND = "channel_tick";
    public static final String ACTION_COUNTDOWN_TIMER =
            "com.fudan.tick.COUNTDOWN_TIMER";
    public static final String ACTION_START = "com.fudan.tick.ACTION_START";
    public static final String ACTION_PAUSE = "com.fudan.tick.ACTION_PAUSE";
    public static final String ACTION_RESUME = "com.fudan.tick.ACTION_RESUME";
    public static final String ACTION_STOP = "com.fudan.tick.ACTION_STOP";
    public static final String ACTION_TICK = "com.fudan.tick.ACTION_TICK";
    public static final String ACTION_FINISH = "com.fudan.tick.ACTION_FINISH";
    public static final String ACTION_AUTO_START
            = "com.fudan.tick.ACTION_AUTO_START";
    public static final String ACTION_TICK_SOUND_ON =
            "com.fudan.timer.ACTION_TICK_SOUND_ON";
    public static final String ACTION_TICK_SOUND_OFF =
            "com.fudan.timer.ACTION_TICK_SOUND_OFF";
    public static final String ACTION_POMODORO_MODE_ON =
            "com.fudan.timer.ACTION_POMODORO_MODE_OFF";
    ...
    private Notification buildNotificationForForeground() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID_FOREGROUND)
                ...
                .setContentText(formatTime(getMillsInTotal()))
                .setContentIntent(pendingIntent)
                .setAutoCancel(true);
        builder.setChannelId(CHANNEL_ID_FOREGROUND); // 将通知与渠道关联
        ...
        if (intent != null) {
            ...
            switch (action) {
                ...
                case ACTION_START:
                    ...
                    mTimer.start();
                    mSound.play();
                    createNotificationChannel(CHANNEL_ID_FOREGROUND, "Foreground Service Channel");
                    startForeground(NOTIFICATION_ID_FOREGROUND, buildNotificationForForeground());
